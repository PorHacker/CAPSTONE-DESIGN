...
while cap.isOpened():
    for idx, action in enumerate(actions):
        ...
        np.save(os.path.join('dataset/raw', f'raw_{action}_{created_time}'), data)
        ...
        np.save(os.path.join('dataset/seq', f'seq_{action}_{created_time}'), full_seq_data)
        ...
        np.save(os.path.join('dataset/normalized', f'normalized_{action}_{created_time}'), normalized_data)
